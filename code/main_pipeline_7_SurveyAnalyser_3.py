...
plt.yticks([], [])
plt.xlim(1,5.5)
plt.gca().set_xticks(prev_ax.get_xticks())
plt.gca().set_xticklabels(prev_ax.get_xticklabels())
plt.gca().xaxis.set_major_locator(prev_ax.xaxis.get_major_locator())
plt.gca().set_xlim(prev_ax.get_xlim())
