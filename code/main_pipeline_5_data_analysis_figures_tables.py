...
plt.subplot(1,3,1)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_repo"]/df_scatter_journal_data["n_simstud"]*100)
plt.xlabel("Journal Impact (h5-median)")
plt.ylabel("Share of Simulation Studies\nWith Repository Last "+str(2024-year_threshold+1)+" Years [%]")
...
plt.subplot(1,3,2)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_video"]/df_scatter_journal_data["n_repo"]*100)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_code"]/df_scatter_journal_data["n_repo"]*100)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_dataset"]/df_scatter_journal_data["n_repo"]*100)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_model"]/df_scatter_journal_data["n_repo"]*100)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_documentation"]/df_scatter_journal_data["n_repo"]*100)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["n_license"]/df_scatter_journal_data["n_repo"]*100)
# plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["av_reposcore"]/df_scatter_journal_data["n_repo"]*100)
plt.xlabel("Journal Impact (h5-median)")
plt.ylabel("Share of Repository Last 5 Years [%]")

plt.subplot(1,3,3)
plt.scatter(df_scatter_journal_data["h5-median"], df_scatter_journal_data["av_reposcore"])
plt.xlabel("Journal Impact (h5-median)")
...
df_data = df_regression[["num_cits_per_year", "num_log_cits_per_year", "num_auths", "num_refs",
                         "has_repository", "has_valid_repository", "repo_score",
                         "has_video", "has_code", "has_dataset", "has_model", "has_documentation", "has_license", 
                         ]]
...
doRegression(df_regression, 
             ...
             X_cols= ['has_repository', "has_video",
                      'num_auths', 'num_refs'],
             fe_year=True,
             fe_journal=True,
